...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-define-read-write-accessor/tags). For example,

```javascript
setReadWriteAccessor = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-define-read-write-accessor@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var setReadWriteAccessor = require( 'path/to/vendor/umd/utils-define-read-write-accessor/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-define-read-write-accessor/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/utils-define-read-write-accessor/actions/workflows/test.yml?query=branch:v0.1.0
